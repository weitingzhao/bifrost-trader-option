...
3. **Check [Database Documentation](database/HOME.md)** for database setup
...
### 🗄️ Database
- **[Database Documentation](database/HOME.md)** ⭐ - Database schema management and guides (SINGLE SOURCE OF TRUTH)
...
See [Database Documentation](database/HOME.md) for details.
...
- See [Database Documentation](database/HOME.md) for database changes

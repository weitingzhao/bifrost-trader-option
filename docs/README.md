...
- **[database/HOME.md](database/HOME.md)** ⭐ - Database schema management and guides (SINGLE SOURCE OF TRUTH)
...
3. Check [database/HOME.md](database/HOME.md) for database setup

### Database Schema Changes
- ⭐ **Single Source of Truth:** `scripts/database/schema.sql`
- See [database/HOME.md](database/HOME.md) for workflow

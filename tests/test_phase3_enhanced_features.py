...
class TestPlotlyCharts:
    ...
    def test_analytics_pages_exist(self):
        ...
        pages_dir = project_root / 'streamlit_apps' / 'analytics' / 'pages'
        required_pages = [
...
class TestStreamlitAnalytics:
    ...
    def test_analytics_app_exists(self):
        ...
        analytics_app = project_root / 'streamlit_apps' / 'analytics' / 'app.py'
...
class TestOptionChainVisualization:
    ...
    def test_option_chain_viewer_exists(self):
        ...
        viewer_page = project_root / 'streamlit_apps' / 'analytics' / 'pages' / 'option_chain_viewer.py'

...
echo ""
echo "   2. Check nginx status (can run locally on server):"
...
echo ""
echo "💡 Tip: check_nginx.sh can be run:"
echo "   - From dev PC: ./scripts/nginx/check_nginx.sh (SSH mode)"
echo "   - On server: ~/bifrost-scripts/nginx/check_nginx.sh (local mode with sudo)"
echo ""
echo "=========================================="

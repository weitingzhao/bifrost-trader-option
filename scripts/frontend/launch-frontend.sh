#!/bin/bash
# Launch Bifrost Frontend (Skote Starterkit-based)
# This script launches the frontend UI for development and testing
...
echo "=========================================="
echo "Bifrost Frontend Launcher"
echo "=========================================="
echo ""
...
if [ ! -f "package.json" ]; then
    ...
    echo "   Please ensure Starterkit code has been copied to frontend/"
    exit 1
fi
...
echo ""
echo -e "${GREEN}✅ Starting Bifrost Frontend on http://localhost:${FINAL_PORT}${NC}"
echo ""
...
echo "  - For Vue.js conversion, see frontend/README.md"

...
echo "📄 Appending schema_options.sql..."
echo "" >> "$OUTPUT_FILE"
echo "-- ============================================================================" >> "$OUTPUT_FILE"
...
echo "📄 Appending schema_strategies.sql..."
echo "" >> "$OUTPUT_FILE"
echo "-- ============================================================================" >> "$OUTPUT_FILE"
...
echo "📄 Appending schema_data_collection.sql..."
echo "" >> "$OUTPUT_FILE"
echo "-- ============================================================================" >> "$OUTPUT_FILE"
...
echo "📄 Adding TimescaleDB hypertable setup..."
cat >> "$OUTPUT_FILE" << 'EOF'

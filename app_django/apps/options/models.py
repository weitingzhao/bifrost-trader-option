...
class OptionSnapshot(models.Model):
    ...
    stock = models.ForeignKey(
        Stock, on_delete=models.CASCADE, related_name="option_snapshots"
    )
    ...
    exchange = models.CharField(
        ...
        null=True,
        db_index=True,
        help_text="Primary exchange for the underlying stock (NYSE, NASDAQ, NYSEAMERICAN, etc.)",
    )
...
class OptionContract(models.Model):
    ...
    snapshot = models.ForeignKey(
        OptionSnapshot, on_delete=models.CASCADE, related_name="contracts"
    )
    symbol = models.CharField(max_length=10, db_index=True)
    ...
    exchange = models.CharField(
        ...
        null=True,
        db_index=True,
        help_text="Exchange for the option contract (OPRA, SMART, etc.)",
    )
